...
class GroupeCursusController extends AbstractController
{
    ...
    public function index(GroupeCursusRepository $groupeCursusRepository, EntityManagerInterface $em): Response
    {
    ...
    public function show(GroupeCursus $groupeCursu,  EntityManagerInterface $em): Response
    {
        $cursus = $em->getRepository(Cursus::class)->findAll();
