...
class MenuController extends AbstractController
{
    ...
    public function afficher_menu($em,$parent,$menus,$niveau){
        ...
        if($niveau_precedent==$niveau && $niveau==0){
            $html.="<ul class='navbar-nav px-4 mx-8'>";
        }
        foreach($menus as $menu){
            ...
            $text_color=($niveau==0)?"text-light":'';
            ...
            if($parent_menu==$parent  && ($isGranted || $role=='ROLE_USER') ){
                ...
                if($enfant){
                    ...
                    $html.="<a href='$route' class='nav-link dropdown-toggle $text_color' data-bs-toggle='dropdown' data-bs-auto-close='outside' >$libelle</a>";
                }else{
                    $html.="<li class='nav-item $drop'>";
                    $html.="<a href='$route' class='nav-link $text_color' >$libelle</a>";
                }
